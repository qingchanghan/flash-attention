...
#define FT_LOG_TRACE(...) FT_LOG(Logger::TRACE, __VA_ARGS__)
#define FT_LOG_DEBUG(...) FT_LOG(Logger::DEBUG, __VA_ARGS__)
#define FT_LOG_INFO(...) FT_LOG(Logger::INFO, __VA_ARGS__)
#define FT_LOG_WARNING(...) FT_LOG(Logger::WARNING, __VA_ARGS__)
#define FT_LOG_ERROR(...) FT_LOG(Logger::ERROR, __VA_ARGS__)
